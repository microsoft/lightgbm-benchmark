...
def get_arg_parser(parser=None):
    ...
    group_lgbm.add_argument("--deterministic", required=False, type=strtobool, default=False)
    group_lgbm.add_argument("--enable_bundle", required=False, type=strtobool, default=True)
